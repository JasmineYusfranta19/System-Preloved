...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="{{ route('seller.products.create') }}" class="btn text-white" style="background:linear-gradient(135deg,#364C84,#E7F1A8 )">
    ...
    <div class="card-body py-3">
        <form action="{{ route('seller.products.index') }}" method="GET" class="row g-2 align-items-end">
            ...
            <div class="col-md-3 d-flex gap-2">
                <button type="submit" class="btn btn-primary flex-grow-1" style="background:#364C84;border-color:#364C84">Filter</button>
    ...
    <div class="card-body p-0">
        @if($products->isEmpty())
            <div class="text-center py-5 text-muted">
                ...
                <a href="{{ route('seller.products.create') }}" class="btn text-white" style="background:linear-gradient(135deg,#8b5cf6,#ec4899)">
            ...
            <table class="table mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="fw-600" style="color:#364C84;font-size:.88rem">{{ $product->formatted_price }}</td>
                        <td>
